---
title: "Introduction to SA24204137"
author: "Liu Yao"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to SA24204137}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

## Ridge Regression for optimal lambda selection
This function performs Ridge regression for a range of lambda values and selects the best lambda based on the lowest Mean Squared Error (MSE) from cross-validation. 
...
This function calculates the Variance Inflation Factor (VIF) for each predictor in a dataset.
